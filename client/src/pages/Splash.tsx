...
export default function Splash() {
  ...
  const reducedMotionDuration = 600

  useEffect(() => {
    const mediaQuery = window.matchMedia('(prefers-reduced-motion: reduce)')
    const duration = mediaQuery.matches ? reducedMotionDuration : defaultDuration
  ...
  return (
    ...
    >
      ...
      <div
        className="relative z-10 flex flex-col items-center justify-center p-6 animate-immersive-fade"
        style={{ animation: `immersiveFade ${defaultDuration}ms cubic-bezier(0.4, 0, 0.2, 1) forwards` }}
      >
        <h1 className="sr-only">Señor Shaعbi</h1>
