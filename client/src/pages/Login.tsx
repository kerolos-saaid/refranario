      ...
      <main className="relative z-10 flex-grow flex items-center justify-center p-4 sm:p-6 w-full">
        ...
        <div className={`w-full max-w-md bg-white border-bookplate shadow-[0px_20px_60px_rgba(0,0,0,0.3)] p-8 sm:p-12 relative overflow-hidden rounded-xl ${shake ? 'animate-shake' : ''}`}>
          ...
          <div className="flex flex-col items-center text-center space-y-8">
            ...
            {/* Login Form */}
            <form onSubmit={handleSubmit} className="w-full space-y-8 mt-4 text-left">
              {error && (
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-xs font-bold uppercase tracking-widest mb-2" style={{ color: '#B02C33' }}>
                    Usuario
                  </label>
                  <input
                    type="text"
