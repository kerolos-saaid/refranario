...
- Search by phrase, word, or meaning
- Category-based filtering (Wisdom, Nature, Family, Time, Honor, etc.)
- Detailed view with usage notes and metadata
- Curator access for adding/editing entries
- Offline support with cached content
- Modern clean aesthetic with green accent colors
