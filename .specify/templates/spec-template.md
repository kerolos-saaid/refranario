...
- How does the flow behave with cached or offline data?
- How are Arabic RTL text, long Spanish/English phrases, and missing translations handled?
- What happens when a curator token is expired, invalid, or lacks admin privileges?
...
- **SR-001**: Protected mutations MUST require server-side admin authorization.
- **SR-002**: API, D1, R2, Queue, Worker AI, cron, and environment binding changes MUST be listed with compatibility or rollout expectations.
